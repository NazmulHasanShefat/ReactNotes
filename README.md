...
<details>
    <summary> React-এর একটি গুরুত্বপূর্ণ ধারণা: createPortal()</summary>


 - React.js ব্যবহার করে অ্যাপ্লিকেশন তৈরি করার সময়, দুটি খুব দরকারী টুল হল createPortal এবং  react-router-dom। এগুলি ভিন্ন ভিন্ন সমস্যার সমাধান করে, কিন্তু একটি আধুনিক ওয়েব অ্যাপ্লিকেশনে প্রায়শই একসাথে ব্যবহার করা হয়।

 - React.createPortal() কী?
সাধারণত, React কম্পোনেন্টগুলি তাদের নিজস্ব প্যারেন্ট কম্পোনেন্টের DOM (Document Object Model) hierarchy-এর মধ্যে রেন্ডার (render) হয়। কিন্তু কখনও কখনও আপনার একটি কম্পোনেন্টকে DOM-এর অন্য কোথাও রেন্ডার করার প্রয়োজন হতে পারে, যেমন <body> ট্যাগ-এর মধ্যে। এই কাজটি করার জন্য createPortal ব্যবহার করা হয়।

 - এটি কেন দরকারী?
Modals বা Pop-ups: যখন আপনি একটি modal তৈরি করেন, তখন আপনি চান এটি অন্যান্য সব উপাদানের উপরে প্রদর্শিত হোক। createPortal ব্যবহার করে, আপনি এটিকে সরাসরি <body> ট্যাগ-এর মধ্যে রেন্ডার করতে পারেন, যা CSS Z-index সম্পর্কিত সমস্যা এড়াতে সাহায্য করে।

 - Tooltips বা Notifications: একই কারণে, একটি টুলটিপ বা নোটিফিকেশনকে বর্তমান কম্পোনেন্টের বাইরে রেন্ডার করলে তা সঠিকভাবে অবস্থান নেয় এবং প্যারেন্ট কম্পোনেন্টের স্টাইল বা overflow প্রপার্টি দ্বারা প্রভাবিত হয় না।

ব্যবহার পদ্ধতি:
createPortal দুটি আর্গুমেন্ট নেয়:
child: যে React উপাদানটি রেন্ডার করতে চান।
container: যে DOM উপাদানটির মধ্যে child-কে রেন্ডার করতে চান।

উদাহরণ:

```jsx
ReactDOM.createPortal(<MyModal />, document.body);
```
</details>